...
write_spherical_function_pairs(double *output, double *output_transpose,
  ...
  if constexpr (i_angular == 0 && j_angular == 0) {
    ...
    atomicAdd(output_transpose + 0 * n_functions + 0, expression);
  }
  if constexpr (i_angular == 0 && j_angular == 1) {
    ...
    atomicAdd(output_transpose + 1 * n_functions + 0, expression);
    expression = +x_pairs[0] * y_pairs[0] * z_pairs[1];
    atomicAdd(output + 0 * n_functions + 2, expression);
    atomicAdd(output_transpose + 2 * n_functions + 0, expression);
  }
  if constexpr (i_angular == 0 && j_angular == 2) {
    ...
    atomicAdd(output_transpose + 3 * n_functions + 0, expression);
    ...
    atomicAdd(output_transpose + 4 * n_functions + 0, expression);
  }
  if constexpr (i_angular == 0 && j_angular == 3) {
    ...
    atomicAdd(output_transpose + 5 * n_functions + 0, expression);
    ...
    atomicAdd(output_transpose + 6 * n_functions + 0, expression);
  }
  if constexpr (i_angular == 0 && j_angular == 4) {
    ...
    atomicAdd(output_transpose + 7 * n_functions + 0, expression);
    ...
    atomicAdd(output_transpose + 8 * n_functions + 0, expression);
  }
  if constexpr (i_angular == 1 && j_angular == 0) {
    expression = +x_pairs[1] * y_pairs[0] * z_pairs[0];
    atomicAdd(output + 0 * n_functions + 0, expression);
    ...
    atomicAdd(output_transpose + 0 * n_functions + 1, expression);
    expression = +x_pairs[0] * y_pairs[0] * z_pairs[1];
    atomicAdd(output + 2 * n_functions + 0, expression);
    atomicAdd(output_transpose + 0 * n_functions + 2, expression);
  }
  if constexpr (i_angular == 1 && j_angular == 1) {
    ...
    atomicAdd(output_transpose + 1 * n_functions + 1, expression);
    expression = +x_pairs[0] * y_pairs[2] * z_pairs[1];
    atomicAdd(output + 1 * n_functions + 2, expression);
    atomicAdd(output_transpose + 2 * n_functions + 1, expression);
    ...
    atomicAdd(output_transpose + 1 * n_functions + 2, expression);
    expression = +x_pairs[0] * y_pairs[0] * z_pairs[3];
    atomicAdd(output + 2 * n_functions + 2, expression);
    atomicAdd(output_transpose + 2 * n_functions + 2, expression);
  }
  if constexpr (i_angular == 1 && j_angular == 2) {
    ...
    atomicAdd(output_transpose + 3 * n_functions + 1, expression);
    ...
    atomicAdd(output_transpose + 4 * n_functions + 1, expression);
    ...
    atomicAdd(output_transpose + 3 * n_functions + 2, expression);
    ...
    atomicAdd(output_transpose + 4 * n_functions + 2, expression);
  }
  if constexpr (i_angular == 1 && j_angular == 3) {
    ...
    atomicAdd(output_transpose + 5 * n_functions + 1, expression);
    ...
    atomicAdd(output_transpose + 6 * n_functions + 1, expression);
    ...
    atomicAdd(output_transpose + 5 * n_functions + 2, expression);
    ...
    atomicAdd(output_transpose + 6 * n_functions + 2, expression);
  }
  if constexpr (i_angular == 1 && j_angular == 4) {
    ...
    atomicAdd(output_transpose + 7 * n_functions + 1, expression);
    ...
    atomicAdd(output_transpose + 8 * n_functions + 1, expression);
    ...
    atomicAdd(output_transpose + 7 * n_functions + 2, expression);
    ...
    atomicAdd(output_transpose + 8 * n_functions + 2, expression);
  }
  if constexpr (i_angular == 2 && j_angular == 0) {
    expression = +1.0925484305920792 * x_pairs[1] * y_pairs[1] * z_pairs[0];
    atomicAdd(output + 0 * n_functions + 0, expression);
    ...
    atomicAdd(output_transpose + 0 * n_functions + 3, expression);
    expression = +0.5462742152960396 * x_pairs[2] * y_pairs[0] * z_pairs[0] -
                 0.5462742152960396 * x_pairs[0] * y_pairs[2] * z_pairs[0];
    atomicAdd(output + 4 * n_functions + 0, expression);
    atomicAdd(output_transpose + 0 * n_functions + 4, expression);
  }
  if constexpr (i_angular == 2 && j_angular == 1) {
    ...
    atomicAdd(output_transpose + 1 * n_functions + 3, expression);
    expression = +1.0925484305920792 * x_pairs[2] * y_pairs[0] * z_pairs[3];
    atomicAdd(output + 3 * n_functions + 2, expression);
    atomicAdd(output_transpose + 2 * n_functions + 3, expression);
    expression = +0.5462742152960396 * x_pairs[5] * y_pairs[0] * z_pairs[0] -
    ...
    atomicAdd(output_transpose + 1 * n_functions + 4, expression);
    ...
    atomicAdd(output_transpose + 2 * n_functions + 4, expression);
  }
  if constexpr (i_angular == 2 && j_angular == 2) {
    ...
    atomicAdd(output_transpose + 3 * n_functions + 3, expression);
    ...
    atomicAdd(output_transpose + 4 * n_functions + 3, expression);
    ...
    atomicAdd(output_transpose + 3 * n_functions + 4, expression);
    ...
    atomicAdd(output_transpose + 4 * n_functions + 4, expression);
  }
  if constexpr (i_angular == 2 && j_angular == 3) {
    ...
    atomicAdd(output_transpose + 5 * n_functions + 3, expression);
    ...
    atomicAdd(output_transpose + 6 * n_functions + 3, expression);
    ...
    atomicAdd(output_transpose + 5 * n_functions + 4, expression);
    ...
    atomicAdd(output_transpose + 6 * n_functions + 4, expression);
  }
  if constexpr (i_angular == 2 && j_angular == 4) {
    ...
    atomicAdd(output_transpose + 7 * n_functions + 3, expression);
    ...
    atomicAdd(output_transpose + 8 * n_functions + 3, expression);
    ...
    atomicAdd(output_transpose + 7 * n_functions + 4, expression);
    ...
    atomicAdd(output_transpose + 8 * n_functions + 4, expression);
  }
  if constexpr (i_angular == 3 && j_angular == 0) {
    expression = +1.7701307697799304 * x_pairs[2] * y_pairs[1] * z_pairs[0] -
                 0.5900435899266435 * x_pairs[0] * y_pairs[3] * z_pairs[0];
    ...
    atomicAdd(output_transpose + 0 * n_functions + 5, expression);
    expression = +0.5900435899266435 * x_pairs[3] * y_pairs[0] * z_pairs[0] -
                 1.7701307697799304 * x_pairs[1] * y_pairs[2] * z_pairs[0];
    atomicAdd(output + 6 * n_functions + 0, expression);
    atomicAdd(output_transpose + 0 * n_functions + 6, expression);
  }
  if constexpr (i_angular == 3 && j_angular == 1) {
    ...
    atomicAdd(output_transpose + 1 * n_functions + 5, expression);
    ...
    atomicAdd(output_transpose + 2 * n_functions + 5, expression);
    expression = +0.5900435899266435 * x_pairs[7] * y_pairs[0] * z_pairs[0] -
    ...
    atomicAdd(output_transpose + 1 * n_functions + 6, expression);
    ...
    atomicAdd(output_transpose + 2 * n_functions + 6, expression);
  }
  if constexpr (i_angular == 3 && j_angular == 2) {
    ...
    atomicAdd(output_transpose + 3 * n_functions + 5, expression);
    ...
    atomicAdd(output_transpose + 4 * n_functions + 5, expression);
    ...
    atomicAdd(output_transpose + 3 * n_functions + 6, expression);
    expression = +0.32232559907763536 * x_pairs[11] * y_pairs[0] * z_pairs[0] -
    ...
    atomicAdd(output_transpose + 4 * n_functions + 6, expression);
  }
  if constexpr (i_angular == 3 && j_angular == 3) {
    ...
    atomicAdd(output_transpose + 5 * n_functions + 5, expression);
    ...
    atomicAdd(output_transpose + 6 * n_functions + 5, expression);
    ...
    atomicAdd(output_transpose + 5 * n_functions + 6, expression);
    ...
    atomicAdd(output_transpose + 6 * n_functions + 6, expression);
  }
  if constexpr (i_angular == 3 && j_angular == 4) {
    ...
    atomicAdd(output_transpose + 7 * n_functions + 5, expression);
    ...
    atomicAdd(output_transpose + 8 * n_functions + 5, expression);
    ...
    atomicAdd(output_transpose + 7 * n_functions + 6, expression);
    ...
    atomicAdd(output_transpose + 8 * n_functions + 6, expression);
  }
  if constexpr (i_angular == 4 && j_angular == 0) {
    expression = +2.5033429417967046 * x_pairs[3] * y_pairs[1] * z_pairs[0] -
                 2.5033429417967046 * x_pairs[1] * y_pairs[3] * z_pairs[0];
    ...
    atomicAdd(output_transpose + 0 * n_functions + 7, expression);
    expression = +0.6258357354491761 * x_pairs[4] * y_pairs[0] * z_pairs[0] -
                 3.755014412695057 * x_pairs[2] * y_pairs[2] * z_pairs[0] +
                 0.6258357354491761 * x_pairs[0] * y_pairs[4] * z_pairs[0];
    atomicAdd(output + 8 * n_functions + 0, expression);
    atomicAdd(output_transpose + 0 * n_functions + 8, expression);
  }
  if constexpr (i_angular == 4 && j_angular == 1) {
    ...
    atomicAdd(output_transpose + 1 * n_functions + 7, expression);
    ...
    atomicAdd(output_transpose + 2 * n_functions + 7, expression);
    expression = +0.6258357354491761 * x_pairs[9] * y_pairs[0] * z_pairs[0] -
    ...
    atomicAdd(output_transpose + 1 * n_functions + 8, expression);
    ...
    atomicAdd(output_transpose + 2 * n_functions + 8, expression);
  }
  if constexpr (i_angular == 4 && j_angular == 2) {
    ...
    atomicAdd(output_transpose + 3 * n_functions + 7, expression);
    ...
    atomicAdd(output_transpose + 4 * n_functions + 7, expression);
    ...
    atomicAdd(output_transpose + 3 * n_functions + 8, expression);
    expression = +0.3418779252867185 * x_pairs[14] * y_pairs[0] * z_pairs[0] -
    ...
    atomicAdd(output_transpose + 4 * n_functions + 8, expression);
  }
  if constexpr (i_angular == 4 && j_angular == 3) {
    ...
    atomicAdd(output_transpose + 5 * n_functions + 7, expression);
    ...
    atomicAdd(output_transpose + 6 * n_functions + 7, expression);
    ...
    atomicAdd(output_transpose + 5 * n_functions + 8, expression);
    expression = +0.369270364048813 * x_pairs[19] * y_pairs[0] * z_pairs[0] -
    ...
    atomicAdd(output_transpose + 6 * n_functions + 8, expression);
  }
  if constexpr (i_angular == 4 && j_angular == 4) {
    ...
    atomicAdd(output_transpose + 7 * n_functions + 7, expression);
    ...
    atomicAdd(output_transpose + 8 * n_functions + 7, expression);
    ...
    atomicAdd(output_transpose + 7 * n_functions + 8, expression);
    ...
    atomicAdd(output_transpose + 8 * n_functions + 8, expression);
  }
}
} // namespace ovlp
